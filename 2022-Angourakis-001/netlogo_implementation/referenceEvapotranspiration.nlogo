...
to setup
  ...
  set ETr (get-ETr par_elevation par_temperature_daily_mean par_temperature_daily_min par_temperature_daily_max par_netSolarRadiation)
...
to-report get-ETr [ elevation temperature_daily_mean temperature_daily_min temperature_daily_max netSolarRadiation ]
  ...
  let e_s (get-vapour-pressure temperature_daily_max + get-vapour-pressure temperature_daily_min) / 2
  let e_a get-vapour-pressure temperature_daily_min
  ...
  let DELTA 4098 * (get-vapour-pressure temperature_daily_mean) / (temperature_daily_mean + 237.3) ^ 2
  ...
  let ETr_temp (0.408 * DELTA * netSolarRadiation + gamma * (C_n / (temperature_daily_mean + 273)) * windSpeed * (e_s - e_a)) / (DELTA + gamma * (1 + C_d * windSpeed))

  report ETr_temp

end

to-report get-vapour-pressure [ temperature ]

  report (0.6108 * exp(17.27 * temperature / (temperature + 237.3)))
...
256
236
par_temperature_daily_max
par_temperature_daily_max
par_temperature_daily_mean
50
35.1
0.1
1
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot par_netSolarRadiation"
...
"" ""
PENS
"mean" 1.0 0 -16777216 true "" "plot par_temperature_daily_mean"
"min" 1.0 0 -13345367 true "" "plot par_temperature_daily_min"
"max" 1.0 0 -2674135 true "" "plot par_temperature_daily_max"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot par_elevation"
