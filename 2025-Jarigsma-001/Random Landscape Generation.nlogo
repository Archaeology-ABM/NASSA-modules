...
globals [
  ...
  biomass-density ;; value for the density of biomass (e.g. wood has a density of 439kg/m3)
]
...
to setup
  ...
  ;; NOTE: the landscape types should be set in order from central landscape to outermost landscape type.
  set landscape-types [
    [1 "levee" 0.2 brown] ; ID, landscape name, proportion of land, color
 ...
 ;; Users need to define the density of biomass (e.g. wood has a density of 439kg/m3)
  set biomass-density 439
