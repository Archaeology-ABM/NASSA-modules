...
languages <- purrr::map(nassa_yml$implementations, function(y) {
  htmltools::tags$span(class = "badge", id = "badgeDefault", y$language)
})
```
...
<table>
<tr><td>Class:</td><td>`r badge_series(nassa_yml$moduleType)`</td></tr>
...
<tr><td>Model:</td><td>`r badge_series(nassa_yml$modellingKeywords, "badgeModelling")`</td></tr>
